 ...
 * waiting.
 *
 * A phone never draws this rail: its ☰ opens `ProjectSheet`, which carries the
 * skills and commands lists that used to hang off the bottom of the drawer.
 */
  ...
  return (
    <div className="rail" data-collapsed={collapsed}>
      {/*
        ...
        this rail by *window* below 640px, so in a narrow window there is no
        toggle to press, and hiding the header there would take Add project
        away altogether.
      */}
