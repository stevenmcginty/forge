 ...
 *
 * Existence-guarded rather than assumed: the file is generated by
 * `npm run icon` (and by `npm run dist`), and it is committed, but a checkout
 * mid-regeneration should start Forge rather than throw.
 */
